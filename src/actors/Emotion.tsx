...
export const EMOTION_SYNONYMS: {[key in Emotion]: string[]} = {
    ...
    embarrassment: ['embarrassed', 'shame', 'ashamed', 'sheepish', 'chagrin', 'mortification', 'abashment', 'selfconsciousness', 'self-consciousness', 'bashfulness', 'bashful', 'flustered', 'fluster', 'unease', 'uneasy', 'awkwardness', 'awkward'],
    ecstasy: ['ecstasy', 'ecstatic', 'orgasm', 'orgasmic', 'finishing', 'coming', 'euphoria', 'euphoric'],
    fear: ['shocked', 'terrified', 'terror', 'panic', 'alarm', 'concern'],
    grief: ['sad', 'upset', 'depressed', 'depression', 'sobbing', 'desperation', 'sorrow', 'despair'],
    guilt: ['remorseful', 'remorse', 'repentant', 'regretful', 'regretting', 'guiltridden', 'penitent', 'penitence'],
    ...
    nervousness: ['anxious', 'uncertain', 'jittery', 'uneasy', 'worry', 'worrying', 'vulnerability', 'vulnerable', 'hesitance', 'anxiety'],
