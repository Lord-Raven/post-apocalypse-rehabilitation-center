...
export const EMOTION_SYNONYMS: {[key: string]: Emotion} = {
    ...
    resentment: Emotion.disappointment,
    defensiveness: Emotion.disappointment,
    arrogance: Emotion.pride,
    arrogant: Emotion.pride,
    mockery: Emotion.disappointment,
    mocking: Emotion.disappointment,
    alarm: Emotion.fear,
    skepticism: Emotion.disappointment,
    anxiety: Emotion.nervousness,
    desperation: Emotion.grief,
    warmth: Emotion.kindness,
}
